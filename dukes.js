...
var ASM_CONSTS = {
  114946: () => { if (document.fullscreenElement) return 1; },  
 114992: () => { return Module.canvas.width; },  
 115024: () => { return parseInt(Module.canvas.style.width); },  
 115072: () => { document.exitFullscreen(); },  
 115099: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 115171: () => { if (document.fullscreenElement) return 1; },  
 115217: () => { return Module.canvas.width; },  
 115249: () => { return screen.width; },  
 115274: () => { document.exitFullscreen(); },  
 115301: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 115495: () => { return window.innerWidth; },  
 115521: () => { return window.innerHeight; },  
 115548: () => { if (document.fullscreenElement) return 1; },  
 115594: () => { return Module.canvas.width; },  
 115626: () => { return parseInt(Module.canvas.style.width); },  
 115674: () => { if (document.fullscreenElement) return 1; },  
 115720: () => { return Module.canvas.width; },  
 115752: () => { return screen.width; },  
 115777: () => { return window.innerWidth; },  
 115803: () => { return window.innerHeight; },  
 115830: () => { if (document.fullscreenElement) return 1; },  
 115876: () => { return Module.canvas.width; },  
 115908: () => { return screen.width; },  
 115933: () => { document.exitFullscreen(); },  
 115960: () => { if (document.fullscreenElement) return 1; },  
 116006: () => { return Module.canvas.width; },  
 116038: () => { return parseInt(Module.canvas.style.width); },  
 116086: () => { document.exitFullscreen(); },  
 116113: ($0) => { Module.canvas.style.opacity = $0; },  
 116151: () => { return screen.width; },  
 116176: () => { return screen.height; },  
 116202: () => { return window.screenX; },  
 116229: () => { return window.screenY; },  
 116256: () => { return window.devicePixelRatio; },  
 116292: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 116345: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 116396: () => { Module.canvas.style.cursor = 'none'; },  
 116433: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 116689: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 116740: () => { if (document.pointerLockElement) return 1; },  
 116787: () => { if (document.fullscreenElement) return 1; },  
 116833: () => { return window.innerWidth; },  
 116859: () => { return window.innerHeight; }
};
